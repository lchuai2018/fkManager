    ...
    <el-submenu :index="item.menuName">
      ...
      <template v-for="child in item.list">
        <sidebar-item
          ...
          :item="child"
          :key="child.powerUrl"
          :base-path="resolvePath(child.powerUrl)"
          class="nest-menu" />
        <app-link v-else :to="resolvePath(child.powerUrl)" :key="child.menuName">
          <el-menu-item :index="resolvePath(child.powerUrl)">
            <item v-if="child.menuName"  :title="child.menuName" />
          </el-menu-item>
        </app-link>
      </template>
    </el-submenu>
